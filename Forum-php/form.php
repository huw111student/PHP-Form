  ...
  <div id="header"><img src="img/ph-header2.png"  width="739"
    ...
    <div id="mainContent">
      ...
      <form action="form-action.php" method="post" name="signup"   id="signup">
        ...
        <p>
          What do you read?
          <br><label><input name="publications[]" type="checkbox" id="publication_drf" value="Buzzfeed"> Buzzfeed</label>
          <br><label><input name="publications[]" type="checkbox" id="publication_elle" value="Reddit"> Reddit</label>
        </p>
        <p>
          Fun Stuff:<br>
          <select name="howoftentrack" id="howoftentrack">
            ...
            <option value="yearly">GIFs</option>
             <option value="never">Forgetten Emails</option>
           </select>
         </p>
         ...
         <input class="botton lgBotton" type"sumbit" name="sumbit"
         id="sumbit" value="Sign Me Up!">
       </form>
     </div>
